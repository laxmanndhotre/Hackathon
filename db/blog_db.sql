...
create table users(user_id int primary key AUTO_INCREMENT ,fullname varchar(30), email varchar(30),password varchar(30),phone_no varchar(15),created_time datetime);
